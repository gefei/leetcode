...
Solution.check_arithmetic_subarrays([4,6,5,9,3,7], l = [0,0,2], r = [2,3,5]) |> IO.inspect()
Solution.check_arithmetic_subarrays([-12,-9,-3,-12,-6,15,20,-25,-20,-15,-10], [0,1,6,4,8,7], [4,4,9,7,9,10]) |> IO.inspect()
